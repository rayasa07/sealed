 ...
 * IDL can be found at `target/idl/vickreynftauction.json`.
 */
export type Vickreynftauction = {
  "address": "6K6aykKN8vrBg8RQDtpeJXm6KUo5hG3KFYfyWdi5YS1e",
  "metadata": {
    "name": "vickreynftauction",
    "version": "0.1.0",
    "spec": "0.1.0",
        ...
        },
        {
          ...
          "pda": {
            "seeds": [
              ...
              {
                "kind": "account",
                "path": "auction_config.seller",
                "account": "auctionConfig"
              },
              {
                "kind": "account",
                "path": "auction_config.nft_mint",
                "account": "auctionConfig"
              }
            ]
          }
  ...
  "errors": [
    ...
    {
      "code": 6014,
      "name": "invalidNftMintDecimals",
      "msg": "Invalid NFT mint decimals"
    },
    {
      "code": 6015,
      "name": "programmableNftNotSupported",
